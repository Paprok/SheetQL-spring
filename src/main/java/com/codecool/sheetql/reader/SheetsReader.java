...
public class SheetsReader {
    ...
    private Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        InputStream in = SheetqlApplication.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
    ...
    public List<List<Object>> getSheetLists(String spreadsheetId, String range) throws IOException, GeneralSecurityException {
